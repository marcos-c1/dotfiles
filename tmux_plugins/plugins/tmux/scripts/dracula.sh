...
main()
{
  ...
  IFS=' ' read -r -a plugins <<< $(get_tmux_option "@dracula-plugins" "git weather cpu-usage ram-usage spotify-tui")
  ...
  for plugin in "${plugins[@]}"; do
    ...
    if case $plugin in custom:*) true;; *) false;; esac; then
      ...
      IFS=' ' read -r -a colors <<< $(get_tmux_option "@dracula-cpu-usage-colors" "light_purple dark_gray")
